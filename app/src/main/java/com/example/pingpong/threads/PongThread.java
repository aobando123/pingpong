package com.example.pingpong.threads;
...
public class PongThread extends Thread {
    ...
    public PongThread(final SurfaceHolder surfaceHolder,
        ...
        int paddleHeight = a.getInt(R.styleable.PongView_paddleHeight, 160);
        int paddleWidth = a.getInt(R.styleable.PongView_paddleWidth, 50);
